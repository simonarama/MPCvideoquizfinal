...
//David Simon
// code modified from Lecture mpc to line quiz solution
// return code from Hangout MPC lecture video 

using CppAD::AD;

// TODO: Set the timestep length and duration
size_t N = 10; //was 25 quiz, 10 works well
double dt = 0.1; //was .05 quiz, 0.1 works well
