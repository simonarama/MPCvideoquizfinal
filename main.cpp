...
//David Simon
//lecture code modified from Hangout MPC lecture video
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          vector<double>next_x_vals; //for optimum trajectory
          ...
          vector<double>mpc_x_vals;  //for calculated trajectory from solver
